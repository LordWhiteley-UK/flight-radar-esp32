    ...
    httpd_req_t *req)
{
    const char html[] =
        ...
        "<h2>Flight Tracker — OpenSky API</h2>"

        "<p>Get a free account at "
        "<a href='https://opensky-network.org/'>opensky-network.org</a>, "
        "create an application, then paste your credentials below.</p>"

        "<form id='f'>"
        "<label>Client ID<br>"
        "<input id='cid' size='36' autocomplete='off'></label>"
        "<br><br>"
        "<label>Client Secret<br>"
        "<input id='csec' size='36' type='password' autocomplete='off'></label>"
        "<br><br>"
